...
public class CustomHeroEditor : Editor {
    ...
    MyHeroClass myHero;
    public string[] myChoices = new string[] { "Damage", "Heal" };
    ...
    public void DrawSpellInfo()
    {
        ...
        string s;
        s = (mySpellType == 0) ? "Damage Amount: " : "Healing Amount: ";
    ...
    {
        Rect rect = GUILayoutUtility.GetRect(0, 18, "TextField");
